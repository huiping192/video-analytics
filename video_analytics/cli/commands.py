    ...
    for i, input_path in enumerate(input_paths, 1):
        ...
        try:
            ...
            if chart_type == "combined":
                ...
                # Use enhanced dashboard implementation for summary
                ...
                enhanced_config.title = f"Analysis Summary - {os.path.basename(input_path)}"
        ...
        for i, file_path in enumerate(files, 1):
            ...
            try:
                ...
                if chart_type == "combined":
                    ...
                    enhanced_config.title = f"Analysis Summary - {file_basename}"
